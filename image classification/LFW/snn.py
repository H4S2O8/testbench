...
parser = argparse.ArgumentParser(description='PyTorch LFWPeople Evaluation')
...
def main():
    ...
    # Replace MNIST dataset with LFW dataset
    print('=> loading LFW data...')
    # LFW dataset has 3 color channels and the pixel values are in the range [0, 255]
    normalize = transforms.Normalize(mean=[0.485, 0.456, 0.406], std=[0.229, 0.224, 0.225])

    # Set the path to your LFW dataset
    lfw_dir = './lfw'

    # Create a transform to resize the images to the size your model expects
    ...
    test_dataset = ImageFolder(root=lfw_dir + '/test', transform=transform)
